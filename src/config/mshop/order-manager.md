...
* Default: mshop/order/manager/service/transaction/aggregate
* Type: string - SQL statement for aggregating order items
* Since: 2023.01
...
* Default: mshop/order/manager/service/transaction/count
* Type: string - SQL statement for counting items
* Since: 2023.01
...
* Default: mshop/order/manager/service/transaction/delete
* Type: string - SQL statement for deleting items
* Since: 2023.01
...
* Default: mshop/order/manager/service/transaction/insert
* Type: string - SQL statement for inserting records
* Since: 2023.01
...
```
mshop/order/manager/service/transaction/newid/ansi = mshop/order/manager/service/transaction/newid
```

* Default: mshop/order/manager/service/transaction/newid
* Type: string - SQL statement for retrieving the last inserted record ID
* Since: 2023.01
...
* Default: mshop/order/manager/service/transaction/search
* Type: string - SQL statement for searching items
* Since: 2023.01
