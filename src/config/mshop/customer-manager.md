...
mshop/customer/manager/group/search/ansi =
 SELECT :columns
 	mcusgr."id" AS "group.id", mcusgr."siteid" AS "group.siteid",
 	mcusgr."code" AS "group.code", mcusgr."label" AS "group.label",
 	mcusgr."mtime" AS "group.mtime", mcusgr."editor" AS "group.editor",
 	mcusgr."ctime" AS "group.ctime"
 FROM "mshop_customer_group" mcusgr
 :joins
 WHERE :cond
 ORDER BY :order
