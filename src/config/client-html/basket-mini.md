...
```
client/html/basket/mini/standard/subparts = Array
(
)
```
...
```
client/html/basket/mini/standard/template-body = basket/mini/body-standard
```
...
```
client/html/basket/mini/standard/template-header = basket/mini/header-standard
```
