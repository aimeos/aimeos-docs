...
```
client/html/catalog/stage/navigator/standard/subparts = Array
(
)
```
...
```
client/html/catalog/stage/navigator/standard/template-body = catalog/stage/navigator-body-standard
```
...
```
client/html/catalog/stage/standard/domains = Array
(
    [0] => attribute
    [1] => media
    [2] => text
...
```
client/html/catalog/stage/standard/subparts = Array
(
    [0] => navigator
)
```
...
```
client/html/catalog/stage/standard/template-body = catalog/stage/body-standard
```
...
```
client/html/catalog/stage/standard/template-header = catalog/stage/header-standard
```
