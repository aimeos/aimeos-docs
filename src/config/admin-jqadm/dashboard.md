...
```
admin/jqadm/dashboard/order/countcountry/template-item = dashboard/item-order-countcountry-standard
```
...
```
admin/jqadm/dashboard/order/quick/countcompleted/template-item = dashboard/item-order-quick-countcompleted-standard
```
...
```
admin/jqadm/dashboard/order/quick/countcustomer/template-item = dashboard/item-order-quick-countcustomer-standard
```
...
```
admin/jqadm/dashboard/order/quick/counttotal/template-item = dashboard/item-order-quick-counttotal-standard
```
...
```
admin/jqadm/dashboard/order/quick/countunfinished/template-item = dashboard/item-order-quick-countunfinished-standard
```
...
```
admin/jqadm/dashboard/order/quick/template-list = dashboard/item-order-quick-standard
```
